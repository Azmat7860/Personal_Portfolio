        ...
        {toast ? (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-sm leading-6 text-[var(--text-secondary)]">{toast.text}</p>
            </div>
            <Tooltip label="Dismiss notification">
              <button
                ...
                className="self-start text-[var(--text-muted)] transition-colors duration-150 hover:text-[var(--text-primary)]"
              >
                <X className="size-4" />
              </button>
            </Tooltip>
